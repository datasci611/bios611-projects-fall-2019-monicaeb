...
##### Report Goals
* To describe the growth that UMD has seen since 2001
* To capture trends about when people are coming and going throughout a calendar year
* To illustrate a need associated with increasing visitors over time: food pantry supply
<br>

##### The number of people served at UMD has grown annually.
Between 2001 and 2018, UMD has seen an overall increase in number of people served. In 2001, 1297 clients were recorded as visiting UMD's campus, and 6074 people were served in the year 2018. 
<br> <img src="clients.year.point.png" width=70%/><br>
...
<br> <img src="new.ids.month.box.png" width=70%/><br>
This plot displays the distribution in the number of new visitors per month over the last 20 years, with means plotted in blue Each point is the number of new clients seen in that month in an individual year. For example, October sees the highest number of monthly new clients, with a mean of 82.2 and median 76.5, and April sees the fewest new people with a median around 60. The overlapping box plots do not indicate a statistically significant difference between months. 
<br>
...
<br> <img src="serv.hist.95.png" width=70%/> <br>
...
<img src="days.range.hist.png" width=70%/>
<br>
...
<img src="last.ids.month.box.png" width=70%/>
<br>
Figure 5 has 2 outliers occurring in November-December 2018. These may be current clients or those who left UMD in 2019, since the data cutoff used in this subset is the end of 2018. 
...
Pounds of food distributed from the pantry and number of clients served are, unsurprisingly, closely associated. The following plot by month excludes months during which food pounds are missing from the source data. 
<br><img src="food.id.reg.scat.png" width=70%/>
<br>

##### Conclusions
Urban ministries has consistently provided services to people of Durham since its operation as a campus began in 2001, and appears to have momentum in its ability to help clients. UMD is on track to continue serving the community and paving a path out of homelessness for individuals in the future. It will not be surprising if food needs continue to increase proportionally with an increase in clients, and new clients can be expected at a relatively consistent rate throughout the year. Community partners and volunteers are integral to UMD's success thus far, and UMD should plan to continue volunteer and donation programs to serve everyone. 
