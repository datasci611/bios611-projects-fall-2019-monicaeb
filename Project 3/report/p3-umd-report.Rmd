...
This report pertains to the shelter at UMD. Dates range from 2012 - 2019, and several datasets were used:
...
* Demographic data included age at entry, gender, race, and ethnicity for each individual.
* Survey data included 5299 records and variables about homelessness status
...
##### Data cleaning
Before creating visuals, categorical variables were binned to make information clearer to communicate. This data cleaning included grouping together similar responses for survey questions such as housing status and destination. 



#### Who is coming to the UMD shelter, and how have clients grown since 2012?
Data provided from 2012 to 2019 cover 2364 clients. If a client returns to UMD after leaving at a different date, their return entry counts as another entry.
...
Since all of the distributions represented by the box plots overlap, we cannot conclude that different months see a significantly different number of departures. 
...
Figure 6 is truncated at the 95% quantile because of how far right-skewed the distribution of days spent at UMD is. The overall median length of stay at UMD is 18 days, and the mean is approximately 43 days. This indicates a right-skew, and the distribution is reflected well by the "Homeless" category in Figure 6. Each point in this figure indicates an outlier, or a length of days stayed at UMD greater than the 75th percentile for a group. 
